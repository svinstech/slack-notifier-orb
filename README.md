...
2.) Make a Jira card on the [Quality team's Jira board](https://vouchinc.atlassian.net/jira/software/c/projects/QA/boards/74/backlog?issueLimit=100) and request to be made a collaborator of the Notifier slack app.
...
2. Find the current version of the orb.
    - You can run `circleci orb info svinstech/slack-notifier-orb | grep "Latest"` to see the current version.
